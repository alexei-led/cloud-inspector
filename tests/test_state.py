...
def test_create_initial_state():
    ...
    state = create_initial_state(request="List EC2 instances", cloud=CloudProvider.AWS, service="ec2")
...
def test_create_initial_state_with_params():
    ...
    state = create_initial_state(request="List EC2 instances", cloud=CloudProvider.AWS, service="ec2", params=params)
